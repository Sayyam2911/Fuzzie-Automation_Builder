    ...
    <main>
      <Navbar />
        <section className={"h-screen w-full bg-neutral-950 rounded-md !overflow-visible relative flex flex-col items-center antialiased"}>
          <div className={"absolute inset-0 h-full w-full items-center px-3 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#223_100%)]"}>
            <div className={"flex flex-col mt-[-100px] md:mt-[-160px]"}>
      ...
      <InfiniteMovingCards items={clients} className="md:mt-[28rem] mt-[-100px] mb-2" direction="right" speed="slow"/>
      <section >
          ...
          <div className={"flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-80"}>
            ...
            <CardContainer className={"inter-var"}>
              <CardBody
                ...
                <CardItem className={"text-xl font-bold text-neutral-600 dark:text-white "} translateZ={"50"}>
                  Pro Plan
                  <h1 className={"text-5xl"}>Rs 499</h1>
                </CardItem>
                <CardItem className={"text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"} translateZ={"60"}>
                  Get a glimpse of what our software is capable of. Just a heads
                  up {"you'll"} never leave us after this!
            ...
            <CardContainer className={"inter-var"}>
              <CardBody
                ...
                <CardItem className={"text-xl font-bold text-neutral-600 dark:text-white "} translateZ={"50"}>
                  Unlimited
                  <h1 className={"text-5xl"}>Rs 999</h1>
                </CardItem>
                <CardItem className={"text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"} translateZ={"60"}>
                  Get a glimpse of what our software is capable of. Just a heads
                  up {"you'll"} never leave us after this!
